...
const encontrarLivrosPorGeneroArrow = (generoArrow) => livros.filter( livro => livro.genero === generoArrow) 
...
const livrosDeAutorAposAno = (autor, ano) => livros.filter( livro => livro.anoPublicacao > ano && livro.autor === autor);
